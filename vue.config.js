...
const { validateProxy } = require('./script')
...
const PROXY_URL = {
	...
	SHW: {
		...
		bill: `http://${testHost}:8585`,
		setting: `http://${testHost}:8585`,
		excel: `http://${testHost}:9191`,
		business: `http://${testHost}:8585`,
		log: `http://${LOG_HOST}`,
		foreign: `http://${testHost}:9696`
	},
	WHY: {
	...
	CC: {
		...
		// archive: 'http://192.168.27.94:8282',
		auth: `http://${devHost}:8585`,
		// auth: 'http://192.168.27.94:8181',
		plan: `http://${devHost}:8585`,
		// plan: 'http://192.168.27.94:8883',
		bill: `http://${devHost}:8585`,
		// bill: 'http://192.168.27.94:8686',
		// bill: 'http://192.168.130.252:8686',
		setting: `http://${devHost}:8585`,
		excel: `http://${devHost}:8585`,
		log: `http://${LOG_HOST}`,
		business: `http://${devHost}:8585`,
