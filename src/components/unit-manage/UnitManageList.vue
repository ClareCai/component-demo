<template>
	<div>
		...
		>
			<w-simple-table-column prop="tools" label="操作" width="46px" align="center">
				<span slot="label">
					<el-popover
						placement="top"
						width="290"
			...
			<w-simple-table-column prop="name" label="单位名称" width="70px" align="center">
			...
			<w-simple-table-column prop="ratio" label="换算系数" width="90px" align="center">
					<span slot="label">
						<span>换算系数</span>
						<el-popover
							placement="top"
			...
			<w-simple-table-column :visible="showCostCardFlag" prop="costCardFlag" label="建立成本卡" width="80px" align="center">
				<div slot-scope="scope">
					<el-checkbox v-model="scope.row.costCardFlag" :disabled="isAssistUnit(scope.row)" :true-label="1" :false-label="0"></el-checkbox>
				</div>
			</w-simple-table-column>
			<w-simple-table-column prop="barcode" label="条码" width="120px" align="center">
				<template slot-scope="scope">
					<w-input
			...
			<w-simple-table-column prop="mainFlag" label="最小" width="40px" align="center">
				<div slot-scope="scope">
					<el-checkbox
			...
			<w-simple-table-column prop="purchaseFlag" label="采购" width="40px" align="center">
				<div slot-scope="scope">
					<el-checkbox
			...
			<w-simple-table-column prop="salesFlag" label="销售" width="40px" align="center">
				<div slot-scope="scope">
			...
			<w-simple-table-column prop="checkFirstFlag" label="盘点1" width="46px" align="center">
				<div slot-scope="scope">
			...
			<w-simple-table-column prop="checkSecondFlag" label="盘点2" width="46px" align="center">
				<div slot-scope="scope">
			...
			<w-simple-table-column prop="reportFlag" label="报表" width="40px" align="center">
				<div slot-scope="scope">
			...
			<w-simple-table-column prop="assistFlag" label="辅助" width="40px" align="center">
				<div slot-scope="scope">
			...
			<w-simple-table-column prop="refCostPrice" label="参考成本" width="72px" align="center">
				<template slot-scope="scope">
					<w-input-number
					...
					<span v-show="!scope.row.isEdit" class="cell-span">{{ scope.row.refCostPrice | filterAutoZeroFill({ len: sysMoneyPointSize }) }}</span>
				</template>
			</w-simple-table-column>
			<w-simple-table-column prop="refSellingPrice" label="参考售价" width="72px" align="center">
				<template slot-scope="scope">
					<w-input-number
					...
					<span v-show="!scope.row.isEdit" class="cell-span">{{ scope.row.refSellingPrice | filterAutoZeroFill({ len: sysMoneyPointSize }) }}</span>
				</template>
			</w-simple-table-column>
		</w-simple-table>
	</div>
		...
		validateEditRow () {
			return new Promise(resolve => {
				...
				if (!currentRow.name) {
					...
					this.$fxMessage.warning('品相换算系数不得小于1')
					this.setCellFocus('ratio', this.currentEditRowIndex)
