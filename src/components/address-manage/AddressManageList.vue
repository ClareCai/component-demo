<template>
	<div>
		...
		>
			<w-simple-table-column prop="areaText" label="省市区" width="180px"></w-simple-table-column>
			<w-simple-table-column prop="location" label="详细地址" width="180px"></w-simple-table-column>
			<w-simple-table-column prop="linkMan" label="联系人" width="80px" align="center"></w-simple-table-column>
			<w-simple-table-column prop="tel" label="联系电话" width="100px" align="center"></w-simple-table-column>
			<w-simple-table-column :visible="!disabled" prop="tools" label="操作" width="80px" align="center">
			...
			<w-simple-table-column prop="default" label="默认" width="60px" align="center">
				<div slot-scope="scope">
