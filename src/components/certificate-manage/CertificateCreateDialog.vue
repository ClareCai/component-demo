<template>
	<w-dailog v-model="dialogVisible" :title="dialogTitle" width="520px" :beforeClose="onBeforeClose">
...
export default {
	...
	computed: {
		...
		certificatTypeList () {
			if (this.resourceList.find(item => item.type === '1') && this.certificatForm.type !== '1') {
