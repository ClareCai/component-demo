	...
	select (h, { item, mouseenterFilter }) {
		...
		return (
			<div class={[
				...
				<div class="fx-filter-item-template__select-label">{item.name}:</div>
	...
	input (h, { item, mouseenterFilter }) {
		...
		return (
			<div class={[
				...
				<div class="fx-filter-item-template__input-label">{item.name}:</div>
	...
	dateRange (h, { item, mouseenterFilter }) {
		...
		return (
			<div class={[
				...
				<div class="fx-filter-item-template__date-range-label">{item.name}:</div>
