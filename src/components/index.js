...
import fxTransferOriginal from './common/Fx-transfer-original.vue'
import fxTransferEdit1 from './common/Fx-transfer-edit1.vue'
...
export default {
	install (Vue) {
		...
		Vue.component('fx-transfer-original', fxTransferOriginal)
		Vue.component('fx-transfer-edit1', fxTransferEdit1)
