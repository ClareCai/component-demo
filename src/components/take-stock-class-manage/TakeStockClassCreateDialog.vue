	...
	>
		...
		<div class="create-area">
			<el-form ref="form" :model="formData" :rules="rules" size="mini" inline>
				<fx-detials-form-row textAlign="right">
				...
				<fx-detials-form-row textAlign="right">
					...
					<el-form-item slot="right" prop="must" label="必盘品项：" label-width="100px">
...
export default {
	...
	data () {
		...
		return {
			...
			rules: {
				...
				must: [{ required: true, trigger: 'no', validator: validateIgnore }],
	...
	computed: {
		...
		showMoreBtn () {
			return !this.isAdd && this.detailsAuthGetter('basic-archives_support-archives_take-stock-class.delete-take-stock-class')
		},
		switchDisabled () {
